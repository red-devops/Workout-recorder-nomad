...
data "aws_secretsmanager_secret_version" "nomad_admin_token" {
  secret_id = "Nomad-Global-Managemen-Token-${terraform.workspace}"
}
...
data "consul_acl_token_secret_id" "read" {
  accessor_id = consul_acl_token.fabio_task.id
}
